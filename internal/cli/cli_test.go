...
func TestSpine_AllVerbsRegistered(t *testing.T) {
	...
	want := []string{"init", "log", "attach", "closeout", "mode", "status", "obs", "day", "stats", "validate", "export", "backup", "restore", "version", "upgrade", "scheduler", "companion", "anchor", "metrics", "storm", "profile", "person", "bootstrap", "serve", "reflect", "ask", "injury", "era", "thread"}
	got := map[string]bool{}
