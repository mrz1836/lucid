...
func TestSpine_AllVerbsRegistered(t *testing.T) {
	...
	want := []string{"init", "log", "attach", "link", "unlink", "annotate", "closeout", "mode", "status", "obs", "reframe", "focus", "retro", "day", "stats", "validate", "export", "backup", "restore", "version", "update", "scheduler", "companion", "anchor", "metrics", "storm", "profile", "person", "bootstrap", "serve", "reflect", "ask", "injury", "era", "thread", "structure"}
	got := map[string]bool{}
