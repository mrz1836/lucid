...
consequences of their own. The workout module's two new observation kinds
...
that ever earns consequences becomes an Engine link through a Gate, exactly like an
eating practice.
