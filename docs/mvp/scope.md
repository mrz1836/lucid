...
| `/person reconcile` | Read-only, no-LLM detector: lists likely-duplicate people (shared normalized aka/name, or near-name proximity) with a suggested merge direction; changes nothing. Byte-stable across runs. | None |
