...
| [`build-plan.md`](build-plan.md) | Ordered build-out: repo bootstrap from the house template (ADR-0007, incl. `lucid update`), Engine-first phase sequencing per `scope.md` §9's dependency note, then Mirror, observations, skill surface, and supervised ops. |
